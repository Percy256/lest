...
@section('content')
  <div class="panel-header">
    <div class="header text-center">
      <h2 class="title">Anka Business Support Notifications</h2>
      <p class="category">
        <a target="_blank" href="https://github.com/mouse0270"></a>. Please checkout the
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="alert alert-info">
              <span>Ssali Benjamin posted new products.</span>
            </div>
            <div class="alert alert-info">
              <button type="button" aria-hidden="true" class="close">
                <i class="now-ui-icons ui-1_simple-remove"></i>
              </button>
              <span>Mboowa Haula products out of stock.</span>
            </div>
            <div class="alert alert-info alert-with-icon" data-notify="container">
              ...
              <span data-notify="message">Ssemaganda Trevour updated stock quantity.</span>
            </div>
            <div class="alert alert-info alert-with-icon" data-notify="container">
              <button type="button" aria-hidden="true" class="close">
                <i class="now-ui-icons ui-1_simple-remove"></i>
              ...
              <span data-notify="icon" class="now-ui-icons ui-1_bell-53"></span>
              <span data-notify="message">Bindya Phillip product returned on 16th September 2022.</span>
            </div>
          </div>
        </div>
      </div>
